...
#if (defined(_MSC_VER) && _MSC_VER <= 1922) || (defined(__GNUC__) && __GNUC__ < 9 && !defined(__clang__))  // VS 2015/2017
std::map <ggml_type, ggml_type_traits> type_traits = {
        ...
        {GGML_TYPE_Q5_0, ggml_type_traits{/* type_name */"q5_0", /* blck_size */QK5_0,
            ...
            /* vec_dot */ ggml_vec_dot_q5_0_q8_0,/* vec_dot_type */ GGML_TYPE_Q8_0,
        ...
        {GGML_TYPE_Q5_1, ggml_type_traits{/* type_name */"q5_1", /* blck_size */QK5_1,
            ...
            /* vec_dot */ggml_vec_dot_q5_1_q8_1,/* vec_dot_type */ GGML_TYPE_Q8_1,
        ...
        {GGML_TYPE_Q8_0, ggml_type_traits{/* type_name */"q8_0", /* blck_size */QK8_0,
            ...
            /* vec_dot */ ggml_vec_dot_q8_0_q8_0,/* vec_dot_type */ GGML_TYPE_Q8_0,
        ...
        {GGML_TYPE_IQ2_XS_R4, ggml_type_traits{/* type_name */"iq2_xs_r4", /* blck_size */QK_K,
            /* type_size */ sizeof(block_iq2_xs),/* is_quantized */  true,
            /* vec_dot */ nullptr,
            /* vec_dot_type */ GGML_TYPE_Q8_K
            // .to_float                 = (ggml_to_float_t) dequantize_row_q2_K,
        ...
        {GGML_TYPE_IQ3_XXS_R4, ggml_type_traits{/* type_name */"iq3_xxs_r4", /* blck_size */QK_K,
            /* type_size */ sizeof(block_iq3_xxs),/* is_quantized */  true,
            /* vec_dot */ nullptr,
            /* vec_dot_type */ GGML_TYPE_Q8_K
            // .to_float                 = (ggml_to_float_t) dequantize_row_iq3_xxs,
        ...
        {GGML_TYPE_IQ2_S_R4, ggml_type_traits{/* type_name */"iq2_s_r4", /* blck_size */QK_K,
            /* type_size */ sizeof(block_iq2_s),/* is_quantized */  true,
            /* vec_dot */ nullptr,
            /* vec_dot_type */ GGML_TYPE_Q8_K
            // .to_float                 = (ggml_to_float_t) dequantize_row_iq2_xs,
        ...
        {GGML_TYPE_IQ1_S, ggml_type_traits{/* type_name */"iq1_s", /* blck_size */QK_K,
        ...
        {GGML_TYPE_IQ1_M, ggml_type_traits{/* type_name */"iq1_m", /* blck_size */QK_K,
        ...
        {GGML_TYPE_IQ4_NL, ggml_type_traits{/* type_name */"iq4_nl", /* blck_size */QK4_NL,
        ...
        {GGML_TYPE_Q8_K32, {/* .type_name */"q8_K", /* .blck_size */QK_K,
            /* type_size */ sizeof(block_q8_K),/* is_quantized */  true,
        }},
        {GGML_TYPE_BF16, ggml_type_traits{/* type_name */"bf16", /* blck_size */1,
            /* type_size */ sizeof(ggml_bf16_t),/* is_quantized */  false,
            nullptr, GGML_TYPE_BF16 ,
