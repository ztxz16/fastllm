#!/bin/bash
# 纯命令行构建 Fastllm Chat APK（无需 Android Studio）
# 依赖：Android NDK, Android SDK (build-tools, platform), JDK
set -e
...
# === Step 1: NDK 编译 libfastllm.so (增量) ===
...
# === Step 3: 链接资源，生成 R.java 和 base APK ===
...
# === Step 5: dex (仅在 class 文件有更新时重新生成) ===
