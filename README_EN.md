...
| `FASTLLM_DFLASH_TP_EARLY_SELECTOR` | `1` | Queues the DFlash2 TP selector projection early on rank 0's head worker stream; `0` disables it. No SM restriction |
