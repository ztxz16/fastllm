#!/usr/bin/env python3
"""Capture processor-free GLM-5.3-Flash logits with FastLLM."""
...
def parse_args():
    parser = make_normal_parser("GLM-5.3-Flash FastLLM raw-logits capture")
...
def main() -> None:
    ...
    try:
        ...
        vocab_size = int(config.get("vocab_size", text_config["vocab_size"]))
