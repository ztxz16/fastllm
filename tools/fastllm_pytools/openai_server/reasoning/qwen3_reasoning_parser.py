...
class Qwen3ReasoningParser(BaseThinkingReasoningParser):
    ...
    Key difference from other parsers: Qwen3 requires BOTH start and end tokens
    to be present for reasoning extraction. If either is missing, the entire
    output is treated as content.
    """
