...
template <>
class MarlinScalarType<fastllm_marlin_moe_types::kFloat16.id()> {
 public:
  using scalar_t = half;
...
template <>
class MarlinScalarType<fastllm_marlin_moe_types::kBFloat16.id()> {
 public:
...
template <>
class MarlinScalarType<fastllm_marlin_moe_types::kFE4M3fn.id()> {
 public:
...
template <>
class MarlinScalarType<fastllm_marlin_moe_types::kS8.id()> {
 public:
...
template <>
class MarlinScalarType2<half> : public MarlinScalarType<fastllm_marlin_moe_types::kFloat16.id()> {};

template <>
class MarlinScalarType2<nv_bfloat16>
    : public MarlinScalarType<fastllm_marlin_moe_types::kBFloat16.id()> {};

template <>
class MarlinScalarType2<__nv_fp8_e4m3>
    : public MarlinScalarType<fastllm_marlin_moe_types::kFE4M3fn.id()> {};

template <>
class MarlinScalarType2<int8_t> : public MarlinScalarType<fastllm_marlin_moe_types::kS8.id()> {};
