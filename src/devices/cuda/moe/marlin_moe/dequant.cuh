/*
 * Adapted from vLLM's Apache-2.0 Marlin implementation.
...
template <typename scalar_t2, fastllm_marlin_moe_types::ScalarTypeId w_type_id,
...
//
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU4B8.id(), true>(int q,
                                                              half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU4B8.id(), false>(int q,
                                                               half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU4.id(), true>(int q,
                                                            half2* frag_b) {
  dequant<half2, fastllm_marlin_moe_types::kU4B8.id(), true>(q, frag_b);
}

template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU4.id(), false>(int q,
                                                             half2* frag_b) {
  const int LO = 0x000f000f;
  const int HI = 0x00f000f0;
  const int EX = 0x64006400;
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kU4B8.id(), true>(
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kU4B8.id(), false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, fastllm_marlin_moe_types::kU4B8.id(), true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kU4.id(), true>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, fastllm_marlin_moe_types::kU4B8.id(), true>(q, frag_b);
}

template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kU4.id(), false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, fastllm_marlin_moe_types::kU4.id(), true>(q, frag_b);
...
//
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU8B128.id(), true>(int q,
                                                                half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU8B128.id(), false>(
    int q, half2* frag_b) {
  dequant<half2, fastllm_marlin_moe_types::kU8B128.id(), true>(q, frag_b);
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU8.id(), true>(int q,
                                                            half2* frag_b) {
  dequant<half2, fastllm_marlin_moe_types::kU8B128.id(), true>(q, frag_b);
}

template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kU8.id(), false>(int q,
                                                             half2* frag_b) {
  dequant<half2, fastllm_marlin_moe_types::kU8.id(), true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kU8B128.id(), false>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kU8.id(), false>(
    int q, nv_bfloat162* frag_b) {
  float fp32_intermediates[4];
  uint32_t* fp32_intermediates_casted =
      reinterpret_cast<uint32_t*>(fp32_intermediates);
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kFE4M3fn.id(), true>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kFE4M3fn.id(), false>(
    int q, half2* frag_b) {
  dequant<half2, fastllm_marlin_moe_types::kFE4M3fn.id(), true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kFE4M3fn.id(), true>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kFE4M3fn.id(), false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, fastllm_marlin_moe_types::kFE4M3fn.id(), true>(q, frag_b);
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kFE2M1f.id(), true>(int q,
                                                                half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, fastllm_marlin_moe_types::kFE2M1f.id(), false>(
    int q, half2* frag_b) {
  dequant<half2, fastllm_marlin_moe_types::kFE2M1f.id(), true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kFE2M1f.id(), true>(
    int q, nv_bfloat162* frag_b) {
  // Constants for FP4 (E2M1) and FP16 formats
...
template <>
__device__ inline void dequant<nv_bfloat162, fastllm_marlin_moe_types::kFE2M1f.id(), false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, fastllm_marlin_moe_types::kFE2M1f.id(), true>(q, frag_b);
...
template <>
__device__ inline void dequant<__nv_fp8x4_e4m3, fastllm_marlin_moe_types::kFE2M1f.id(), true>(
...
template <>
__device__ inline void dequant<int32_t, fastllm_marlin_moe_types::kU4B8.id(), true>(
...
template <>
__device__ inline void dequant<__nv_fp8x4_e4m3, fastllm_marlin_moe_types::kU4B8.id(), true>(
    int q, __nv_fp8x4_e4m3* frag_b) {
  int s = q & 0x08080808;
...
template <typename scalar_t2, fastllm_marlin_moe_types::ScalarTypeId s_type_id>
__device__ inline void dequant_fp8_scales(int q, scalar_t2* frag_b);

template <>
__device__ inline void dequant_fp8_scales<half2, fastllm_marlin_moe_types::kFE4M3fn.id()>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant_fp8_scales<nv_bfloat162, fastllm_marlin_moe_types::kFE4M3fn.id()>(
    int q, nv_bfloat162* frag_b) {
  constexpr int FP8_EXPONENT = 4, BF16_EXPONENT = 8;
  constexpr int RIGHT_SHIFT = BF16_EXPONENT - FP8_EXPONENT;
  constexpr int MASK = 0x7F007F00;
...
template <>
__device__ inline void dequant_fp8_scales<nv_bfloat162, fastllm_marlin_moe_types::kFE8M0fnu.id()>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void sub_zp_and_dequant<int32_t, fastllm_marlin_moe_types::kU4.id(), true>(
...
template <>
__device__ inline void sub_zp_and_dequant<__nv_fp8x4_e4m3, fastllm_marlin_moe_types::kU4.id(),
