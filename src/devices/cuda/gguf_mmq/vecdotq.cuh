...
static __device__ __forceinline__ float vec_dot_iq3_s_q8_1(
    ...
    const uint64_t qs_packed =
        (uint64_t)(uint32_t)get_int_b2(bq3->qs, iqs + 0) |
        ((uint64_t)(uint32_t)get_int_b2(bq3->qs, iqs + 1) << 32);
...
#pragma unroll
    for (int l0 = 0; l0 < 8; l0 += 2) {
        const unsigned q0 = (qs_packed >> (8u*(unsigned)(l0 + 0))) & 0xffu;
        const unsigned q1 = (qs_packed >> (8u*(unsigned)(l0 + 1))) & 0xffu;
        const unsigned signs = (signs_packed >> (8u*(unsigned)(l0/2))) & 0xffu;
        const int2 grid_pos = make_int2(
            iq3s_grid[q0 | ((qh << (8 - l0)) & 0x100)],
            iq3s_grid[q1 | ((qh << (7 - l0)) & 0x100)]);
...
static __device__ __forceinline__ float vec_dot_iq1_s_q8_1(
    ...
    const uint32_t qs_packed = (uint32_t)get_int_b2(bq1->qs, iqs);
...
#pragma unroll
    for (int l0 = 0; l0 < 8; l0 += 2) {
        const unsigned q = (qs_packed >> (8u*(unsigned)(l0/2))) & 0xffu;
        const int grid = iq1s_grid_gpu[q | (((qh >> 3*(l0/2)) & 0x07) << 8)];
...
static __device__ __forceinline__ float vec_dot_iq1_m_q8_1(
    ...
    const uint32_t qs_packed = (uint32_t)get_int_b4(bq1->qs, iqs);
...
#pragma unroll
    for (int l0 = 0; l0 < 8; l0 += 2) {
        ...
        const unsigned q = (qs_packed >> (8u*(unsigned)(l0/2))) & 0xffu;
        const int grid = iq1s_grid_gpu[q | ((qhl & 0x07) << 8)];
