...
[[noreturn]] static void ggml_cuda_error(const char * stmt, const char * func, const char * file, int line, const char * msg) {
    fprintf(stderr, "ROCm MMQ: %s: %s (%s:%d, %s)\n", stmt, msg, file, line, func); std::abort();
}
